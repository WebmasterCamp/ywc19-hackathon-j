  ...
  if (huayState == 0) {
    return (
      ...
      >
        ...
        <div className={`flex flex-col gap-2 w-full h-full px-6 ${lottoCart.length != 0 ? 'mb-28' : 'mb-4'}`}>
    ...
    >
      ...
      <div className={`flex flex-col gap-2 w-full h-full px-6 `}>
        <LotteryChart lottoCart={lottoCart} setLottoCart={setLottoCart} setHuayState={setHuayState} />
      </div>
    ...
    >
      ...
      <div className={`flex flex-col gap-2 w-full h-full px-6 `}>
        <LotteryPaid lottoCart={lottoCart} setLottoCart={setLottoCart} setHuayState={setHuayState} />
      </div>
